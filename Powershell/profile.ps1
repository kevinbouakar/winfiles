...
$ENV:STARSHIP_CONFIG = "$HOME\.dotfiles\.config\Starship\kevin.toml" 

#  _______  _        _       _________ _______  _______  _______  _______ 
...
function kevfetch {fastfetch -c C:\Users\elio\.config\fastfetch\kevfetchv2.jsonc}
...
function omp {oh-my-posh init pwsh --config "C:\Users\elio\AppData\Local\Programs\oh-my-posh\themes\catppuccin.omp.json" | Invoke-Expression}
function sudo { cd "C:\Program Files\"
